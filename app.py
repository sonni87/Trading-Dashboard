...
class TradeRepublicAnalyzer:
    ...
    def analyze(self):
        ...
        # Remaining FIFO lots are open positions.
        for key, lots in self.lots_by_key.items():
            ...
            for lot in lots:
                ...
                self.open_positions.append(dict(
                    ...
                    shares=lot['shares'],
                    avg_cost=lot['total_cost'] / lot['shares'] if lot['shares'] else 0,
...
def render_tr_tab(tr: TradeRepublicAnalyzer):
    ...
    if tr.open_positions:
        ...
        st.download_button(
            "📥 Download open TR lots CSV",
            op_df.to_csv(index=False),
            "trade_republic_open_lots_fifo.csv",
            "text/csv",
